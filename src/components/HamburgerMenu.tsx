...
export default function HamburgerMenu({ items, locale }: HamburgerMenuProps) {
    ...
    return (
        <div className="relative">
            ...
            {/* Menú desplegable */}
            <div 
                className={`${isOpen ? 'translate-x-0' : 'translate-x-full'} fixed top-0 right-0 h-screen w-64 bg-black/50 backdrop-blur-sm transform transition-transform duration-300 ease-in-out z-50`}
            >
